"""
Django settings for konkon project.
...
SECRET_KEY = 'django-insecure-9ur@oyd&n*l)og2%=g!k8_5ogdd^311-m&fge3tpv6y-vbvrvc'
...
WSGI_APPLICATION = 'konkon.wsgi.application'
